...
public class Register2 extends AppCompatActivity {
    ...
    public void addPatient2(View addButton) {
        ...
        if(rowId>0) {
            ...
            Intent i = new Intent (Register2.this, ConnexionPatient.class);
            startActivity(i);
        } else {
    ...
    public void updatePatient(View addButton)
    {
        ...
        if(rowId>0) {
            ...
            Intent i = new Intent (Register2.this, GestionPatient.class);
            startActivity(i);
        } else {
